    ...
    <div class="container-fluid box ">
      <div class="top">
          ...
          <div class="limits-box">
            <div class="limit">
              <a id="thirty" class="yellow"  href="#" >30seconds</a>
              <a id="sixty"  href="#" >60s</a>
            </div>
            <div class="limit">
              <a id="beg" class="yellow"  href="#" >beginner</a>
              <a id="pro"  href="#" >expert in tyiping</a>
            </div>
      ...
      <footer class="center">project prepared :<a class="grey" href=" ">koppoku sudheerbabu</a></footer>
    </div>
